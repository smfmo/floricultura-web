...
public class RegioesAtendidasService {
    ...
    static {
        REGIOES_ATENDIDAS.put("Santa Maria", new BigDecimal("35"));
        REGIOES_ATENDIDAS.put("Céu Azul", new BigDecimal("20"));
        REGIOES_ATENDIDAS.put("Valparaíso 2", new BigDecimal("15"));
        REGIOES_ATENDIDAS.put("Jardim Oriente", new BigDecimal("10"));
        REGIOES_ATENDIDAS.put("Morada Nobre", new BigDecimal("10"));
        REGIOES_ATENDIDAS.put("Setor A", new BigDecimal("15"));
        REGIOES_ATENDIDAS.put("Setor B", new BigDecimal("15"));
        REGIOES_ATENDIDAS.put("Setor C", new BigDecimal("15"));
        REGIOES_ATENDIDAS.put("Setor D", new BigDecimal("15"));
        REGIOES_ATENDIDAS.put("Setor E", new BigDecimal("15"));
        ...
        REGIOES_ATENDIDAS.put("Mansões recreio Mossoró", new BigDecimal("30"));
        REGIOES_ATENDIDAS.put("Parque Araguari 2", new BigDecimal("30"));
        REGIOES_ATENDIDAS.put("Jardim Flamboyant", new BigDecimal("30"));
        REGIOES_ATENDIDAS.put("Parque Nápolis - Cidade Ocidental", new BigDecimal("30"));
